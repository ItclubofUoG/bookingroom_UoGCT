...
amount.addEventListener('change', function(event) {
    ...
    // Check if the number is NaN (not a number) or less than or equal to 0
    if (isNaN(number) || number <= 0) {
        errorAmount.innerHTML = "The amount of Student must be a positive number."
        isAmount = 0
    } else {
